...
Page
{
    ...
    readonly property QtObject trendingBackend: Dispatcher.trendingBackend
    ...
    SearchBar
    {
        ...
        onAccepted:
        {
            ...
            if(text !== "")
            {
                ...
                trendingBackend.trendingAPI.searchKeyword = text
    ...
    AppListView
    {
        ...
        model: trendingBackend.articleModel
